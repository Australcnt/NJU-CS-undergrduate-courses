...
def test_switch():
    ...
    s.expect(
        ...
        ("Ethernet frame destined for 30:00:00:00:00:02 should be "
         "out eth1 because the switch has already remembered the interface")
    )
    
    # test case 3: a frame with unkown dest address should be flooded to 
    # all ports except ingress because ltv was removed
    reqpkt = new_packet(
        "20:00:00:00:00:03",
        "20:00:00:00:00:01", 
        "192.168.3.100",
    ...
    s.expect(
        ...
        ("Ethernet frame destined for 20:00:00:00:00:01 should be flooded "
