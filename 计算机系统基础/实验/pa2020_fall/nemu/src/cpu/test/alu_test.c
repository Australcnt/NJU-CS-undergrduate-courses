...
void alu_test_imul() {
	...
	//TEST_EFLAGS test_eflags;
	int input[] = {-4,-3, -2, -1, 0, 1, 2, 3, 4, 0x0fffffff, 0xefffffff, 0x80000000};
	int n = sizeof(input) / sizeof(int);
	int i, j;
	for(i = 0 ; i < n ; i++) {
		for(j = 0 ; j < n ; j++) {
...
void alu_test_mul() {
	...
	uint32_t a, b, res_asm_a, res_asm_d, res_eflags;
	TEST_EFLAGS test_eflags;
	int input[] = {0xffffffff,-3, -2, -1, 0, 1, 2, 4, 5, 0xefffffff, 0x80000000};
	int n = sizeof(input) / sizeof(int);
	int i, j;
	for(i = 0 ; i < n ; i++) {
		for(j = 0 ; j < n ; j++) {
...
void alu_test_div() {
	...
	uint32_t b;
	uint32_t quo, quo_asm, rem, rem_asm;
	uint32_t input[] = {-3, -2, -1, 1, 2, 3, 4, 0x80000000};
	int n = sizeof(input) / sizeof(uint32_t);
	int i, j;
	for(i = 0 ; i < n ; i++) {
		for(j = 0 ; j < n ; j++) {
