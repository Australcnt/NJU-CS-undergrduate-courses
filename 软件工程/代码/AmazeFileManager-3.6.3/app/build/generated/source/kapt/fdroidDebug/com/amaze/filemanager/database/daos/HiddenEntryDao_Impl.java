...
public final class HiddenEntryDao_Impl implements HiddenEntryDao {
  ...
  public HiddenEntryDao_Impl(RoomDatabase __db) {
    this.__db = __db;
    this.__insertionAdapterOfHidden = new EntityInsertionAdapter<Hidden>(__db) {
      @Override
      ...
      @Override
      public void bind(SupportSQLiteStatement stmt, Hidden value) {
    ...
    this.__updateAdapterOfHidden = new EntityDeletionOrUpdateAdapter<Hidden>(__db) {
      @Override
      public String createQuery() {
    ...
    this.__preparedStmtOfDeleteByPath = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "DELETE FROM hidden WHERE path = ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public Completable insert(final Hidden instance) {
    return Completable.fromCallable(new Callable<Void>() {
      @Override
      public Void call() throws Exception {
        __db.beginTransaction();
        try {
          __insertionAdapterOfHidden.insert(instance);
  ...
  @Override
  public Completable update(final Hidden instance) {
    return Completable.fromCallable(new Callable<Void>() {
      @Override
      public Void call() throws Exception {
        __db.beginTransaction();
        try {
          __updateAdapterOfHidden.handle(instance);
          __db.setTransactionSuccessful();
          return null;
        } finally {
          __db.endTransaction();
  ...
  public Single<List<String>> listPaths() {
    final String _sql = "SELECT path FROM hidden";
