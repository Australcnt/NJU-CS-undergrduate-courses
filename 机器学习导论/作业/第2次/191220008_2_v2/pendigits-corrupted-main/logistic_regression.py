...
# 模型训练
begin = time.time()
model = LogisticRegression(penalty='l2', solver='lbfgs', max_iter=500, random_state=14)
#model = LogisticRegression(penalty='l2', solver='lbfgs', max_iter=500, random_state=14, class_weight='balanced')
