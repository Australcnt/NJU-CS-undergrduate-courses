...
public final class ListHeaderBinding implements ViewBinding {
  ...
  private ListHeaderBinding(@NonNull RelativeLayout rootView, @NonNull RelativeLayout second,
  ...
  public static ListHeaderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListHeaderBinding((RelativeLayout) rootView, second, text);
    }
